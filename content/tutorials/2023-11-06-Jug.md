...
**tl;dr**: Learn how to use [Jug](https://jug.rtfd.io/).

### Learning objectives

At the end of this tutorial you should know

- What is [Jug](https://jug.rtfd.io/),
...
- Jug webpage: [https://jug.rtfd.io/](https://jug.rtfd.io/)
- Jug manuscript: [Coelho, 2017](https://doi.org/10.5334/jors.161)
