...
We were previously at Fudan University in Shanghai at the [Institute of Science and Technology for Brain-Inspired Intelligence](https://istbi.fudan.edu.cn).
...
<span title="tool">🛠️</span> **Aug 4** [NGLess 1.6.0](/software/ngless) released! NGLess is now written in Rust (versions up to 1.5 were Haskell), which simplifies building, installing, and contributing, while remaining a compatible replacement for 1.5. The HTML run report is now a single self-contained file that works offline, see the [ChangeLog](https://ngless.readthedocs.io/en/latest/whatsnew.html#version-1-6-0).
